      ...
      getLink: function(map, path) {
        ...
        var prevLink = function() {
          ...
          if (currentFolderKey == 0 && currentFileKey == 0) {
            ...
            if (currentFileKey == 0) {
              var targetfolderKey = currentFolderKey - 1;
              var targetFolder = map[currentVersion][targetfolderKey];
              var targetFileKey = targetFolder.files.length - 2;
            } else {
              var targetFileKey = currentFileKey - 1;
